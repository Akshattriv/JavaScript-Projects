# JavaScript-Projects
 Color - Flipper. Simple and Hex Mode available. Four colors available in simple and random infinite colors available in hex mode.
 
 Counter - Increases, Decreases, Reset's the count variable 
